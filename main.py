...
import smtplib
import ssl
from pyfirmata import Arduino #audrino code connected
port = "COM3"
    ...
    if uploaded_file is not None:
        ...
        with st.spinner(f"Working... 💫"):
            ...
            for column in records:
                    ...
                    #     email_sender = 'jayaprakash.cs21@bitsathy.ac.in'
                    #     email_password = 'nykn pcwj mlto dbmu'
                    #     email_receiver = ['prasad.cs21@bitsathy.ac.in','rajgokul.it21@bitsathy.ac.in','moulyvinayaka.it21@bitsathy.ac.in','swetha.cs21@bitsathy.ac.in','santhanasri.se21@bitsathy.ac.in']

                    #     # Set the subject and body of the email
                    #     subject = 'verified Message !!!'
                    #     body = """
                    #     Vehicle Number Plate is matched..
                    #     """
...
st.markdown("<br><hr><center>Made with ❤️ by <a href='rajgokul.it21@bitsathy.ac.in?subject=Automatic Number Plate Recognition WebApp!&body=Please specify the issue you are facing with the app.'><strong>RS</strong></a></center><hr>", unsafe_allow_html=True)
...
#     data=cursor.execute(SELECT * FROM final)
#     numberplate=['MH 20 EE 7598','UP32 CJ 8469','OD-11H-7299']
